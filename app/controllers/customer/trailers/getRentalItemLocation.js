...
/** 
 * 
 * @api {GET} /user/rental/locations Get Rental Item Locations
 * @apiName CA - Get Rental Item Locations
 ...
 * @apiSuccess {Boolean} isTracking Is Tracking
 ...
 * 
 */
async function getRentalItemLocation(req, res) {
    ...
    let existingRental = await Invoice.findOne({ _id: rentalId, bookedByUserId: req.userId }, { isTrackingPickUp: 1, isTrackingDropOff: 1 });
