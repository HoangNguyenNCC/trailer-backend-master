...
/** 
 * 
 * @api {PUT} /rental/transaction Save Details of Transaction Authorisation for Rental Item
 ...
 * 
 * 
 * @apiDescription API Endpoint to be used to save Cart Item or Rental Transaction data
 * 
 * 
...
async function saveCartItemTrasaction(req, res, next) {
    ...
    try {
        ...
        const rentalObj = {
            transactionIdAuth: rentalBody.transId,
        ...
        let errorCode = 500;
        let errors = [];
        let errorMessage = "Error while saving Cart Item or Rental Transaction data";
...
module.exports = saveCartItemTrasaction;