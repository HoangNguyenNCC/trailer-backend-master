...
const createLicenseeStripeAccount = require('./createLicenseeStripeAccount');
...
/** 
 * 
 * @api {POST} /licensee Licensee Signup
 * @apiName LA - Licensee Signup
 ...
 * @apiParam {String} employee[mobile] Owner Mobile ( required ) (same as Licensee Mobile) (poor design, needs fixing in future revisions)
 ...
 * 
 * 
 * @apiDescription API Endpoint POST /licensee
 * 
 * 
 * @apiParamExample {json} Request-Example: 
 * 
 * 
    curl --location --request POST 'http://localhost:3000/licensee' \
    --form 'reqBody={
        "employee": {
            "name": "NO NO",
            "mobile": "9664815262",
            "country": "india",
            "email": "MO@licenseetrailers.com",
            "password": "aBcd@1234",
            "title": "Owner",
            "dob": "1970-05-15",
            "driverLicense": {
        ...
        "licensee": {
            ...
            "mobile": "9664815262",
            "country": "india",
            "email": "khksdf@licenseetrailers.com",
            "address": {
                "text": "NorthBridge, NSW, Australia",
                "pincode": "1560",
                "coordinates": [-33.8132, 151.2172],
            ...
            "mcc": "7513",
            "url": "http://qwerty.licenseetrailers.com",
            "productDescription": "Trailer Rental", 
            "taxId": "123456789"
        }
    }' \
    --form 'licenseeLogo=@/home/aditya/Downloads/lightweight-trailer.jpg' \
    --form 'licenseeProofOfIncorporation=@/home/aditya/Downloads/lightweight-trailer.jpg' \
    --form 'employeePhoto=@/home/aditya/Downloads/lightweight-trailer.jpg' \
    --form 'employeeDriverLicenseScan=@/home/aditya/Downloads/lightweight-trailer.jpg'
 * 
 * 
 * 
...
async function saveLicensee(req, res, next) {
        ...
        if(employeeBody.driverLicense) {
            ...
            // if(!moment(employeeBody.driverLicense.expiry, "YYYY-MM").add(2, "days").endOf("month").isAfter(moment())) {
        ...
        // if(licensee.logo) {
        //     licensee.logo = getFilePath("licenseelogo", licensee._id.toString());
        // }

        // if(licensee.proofOfIncorporation) {
        //     licensee.proofOfIncorporation = getFilePath("licenseeproof", licensee._id.toString());
        // }
        ...
        if(employeeBody.driverLicense){
            employeeBody.driverLicense.expiry = moment(employeeBody.driverLicense.expiry).format('YYYY-MM-DD') 
        }
        ...
        req.licenseeObj = licensee;
        req.employeeObj = employee;
        // ----------------------------------------------------------------------------
        ...
        const stripeAccount = await createLicenseeStripeAccount(licensee, employee,reqIP, req.query.isTest);

        await Licensee.findByIdAndUpdate(licensee._id, {
            $set: {
