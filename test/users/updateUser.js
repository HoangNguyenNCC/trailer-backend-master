...
describe('User', () => {
    ...
    describe('PUT /user', () => {
        ...
        it('it should update user data and send 200 response', (done) => {
                        ...
                        chai
                            ...
                            .end((err, res) => {
                                ...
                                chai
                                    ...
                                    .field('reqBody', JSON.stringify(updateUserObj))
                                    .attach('photo', '/home/nimap/Downloads/user.png', 'user.png')
                                    .attach('driverLicenseScan', '/home/nimap/Downloads/driver_license_sample.jpeg', 'driver_license_sample.jpeg')
                                    .end((err, res) => {
                                        if (err) {
        ...
        it('it should give error "User with the specified ID does not exist" while updating user data', (done) => {
        ...
        it('it should give error "Address Text is required" while updating user data', (done) => {
