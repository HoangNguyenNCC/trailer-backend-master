...
describe('Trailers', () => {
    ...
    describe('GET /trailer ', () => {
        ...
        it('it should send failure response with "Trailer ID is undefined" error', (done) => {
            ...
            chai
                ...
                .end((err, res) => {
                    ...
                    // console.log("POST /signup Response", res.body);
                    ...
                    User.findOne({}).then((userObject) => {
                        ...
                        chai
                            ...
                            .end((err, res) => {
                                ...
                                // console.log(res);
                                // console.log("POST /signin Response", res.body);
                                ...
                                chai
                                    ...
                                    .end((err, res) => {
                                        ...
                                        // console.log("GET /trailer Response", res.body);
                                        res.should.not.have.status(200);
                                        res.body.should.have.property('success').eq(false);
                                        res.body.should.have.property('errorsList').includes('Trailer ID is undefined');
                                        done();
                                    });
                            });
                    });
        ...
        it('it should send failure response with "Trailer not found" error', (done) => {
                    ...
                    User.findOne({}).then((userObject) => {
                        ...
                        chai
                            ...
                            .end((err, res) => {
                                ...
                                chai
                                    .request(app)
                                    .get('/trailer?id=5e41314d603c2159b3e45678')
                                    .set('Cookie', userCookie)
                                    .send()
                                    .end((err, res) => {
                                        if (err) {
                                        ...
                                        res.should.not.have.status(200);
                                        res.body.should.have.property('success').eq(false);
                                        res.body.should.have.property('errorsList').includes('Trailer not found');
                                        done();
                                    });
        ...
        it('it should send success response with Rental Charges List', (done) => {
                                                    ...
                                                    .end((err, res) => {
                                                        ...
                                                        chai
                                                            ...
                                                            .end((err, res) => {
                                                                ...
                                                                // console.log("GET /trailer?id=<trailerId> Response", res.body);
                                                                ...
                                                                chai
                                                                    .request(app)
                                                                    .get(`/trailer/${trailerObj._id}/rentalcharges`)
                                                                    .set('Cookie', userCookie)
                                                                    .send()
                                                                    .end((err, res) => {
                                                                        if (err) {
                                                                        ...
                                                                        // console.log("GET /trailer/${trailerObj._id}/rentalcharges Response", res.body);
        ...
        it('it should return 200 response with trailer and cart item data', (done) => {
                ...
                .end((err, res) => {
                    ...
                    chai
                        ...
                        .end((err, res) => {
                            ...
                            // console.log("POST /employee/signin Response", res.body);
                                ...
                                .end((err, res) => {
                                    ...
                                    chai
                                        ...
                                        .end((err, res) => {
                                            ...
                                            // console.log("POST /commission Response", res.body);
                                            ...
                                            chai
                                                ...
                                                .end((err, res) => {
                                                    ...
                                                    // console.log("POST /discount Response", res.body);
                                                                    ...
                                                                    .end((err, res) => {
                                                                        ...
                                                                        chai
                                                                            ...
                                                                            .end((err, res) => {
                                                                                ...
                                                                                const getRoute = `/trailer?id=${trailerObj._id}`
