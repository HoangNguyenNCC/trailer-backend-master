...
describe('Trailer Rentals', () => {
    ...
    describe('POST /rental ', () => {
        ...
        it('it should return 200 response with cart item data - flat', (done) => {
        ...
        it('it should return 200 response with cart item data - percentage', (done) => {
                        ...
                        .end((err, res) => {
                            ...
                            chai
                                ...
                                .end((err, res) => {
                                    ...
                                    const commissionObj = commissionData.VALID_COMMISION_PERCENTAGE;
                                    commissionObj.itemId = trailerObj.adminRentalItemId.toString();
                                    ...
                                    chai
                                        ...
                                        .end((err, res) => {
                                            ...
                                            const discountObj = discountData.VALID_DISCOUNT_PERCENTAGE;
                                            discountObj.itemId = trailerObj.adminRentalItemId.toString();
        ...
        it('it should return 200 response with extension data for a rental cart item', (done) => {
                                                        ...
                                                        chai
                                                            ...
                                                            .end((err, res) => {
                                                                ...
                                                                const extensionObj = {
                                                                    ...
                                                                    extendTill: new Date(rentalObj.rentalPeriod.end).getTime() + 32400000
                                                                };
        ...
        it('it should return 200 response with cancellation data for a rental cart item', (done) => {
        ...
        it('it should return 200 response with rescheduling data for a rental cart item', (done) => {
