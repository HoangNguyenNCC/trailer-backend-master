...
describe('Trailer Insurance', () => {
    ...
    describe('GET /insurance ', () => {
        ...
        it('it should return 200 status code with empty Trailer Insurance List', (done) => {
                        ...
                        .end((err, res) => {
                            ...
                            chai
                                ...
                                .end((err, res) => {
                                    ...
                                    const insuranceGetUrl = `/insurance?itemId=${trailerObj._id.toString()}`
                                    ...
                                    chai
                                        ...
                                        .end((err, res) => {
                                            ...
                                            res.should.have.status(200);
                                            res.body.should.have.property('success').eq(true);
                                            res.body.should.have.property('insuranceList');
                                            res.body.should.have.property('insuranceList').to.be.empty;
        ...
        it('it should return 200 status code with 1 Trailer Insurance element', (done) => {
                                        ...
                                        .end((err, res) => {
                                            ...
                                            chai
                                                ...
                                                .end((err, res) => {
                                                    ...
                                                    res.body.should.have.property('success').eq(true);
                                                    res.body.should.have.property('insuranceList');
                                                    res.body.should.have.property('insuranceList').not.to.be.empty;
