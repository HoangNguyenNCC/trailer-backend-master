...
describe('Trailers', () => {
    ...
    describe('GET /trailers ', () => {
        ...
        it('it should return 200 status code with array of trailers', (done) => {
                                                ...
                                                .end((err, res) => {
                                                    ...
                                                    chai
                                                        ...
                                                        .end((err, res) => {
                                                            ...
                                                            res.should.have.status(200);
                                                            res.body.should.have.property('success').eq(true);
                                                            res.body.should.have.property('trailersList');
                                                            // res.body.should.have.property('trailersList').to.be.empty;
                                                            done();
                                                        });
                                                });
                                        });
        ...
        it('it should return 200 status code with blank array', (done) => {
        ...
        it('it should return 200 status code with blank array - token based authentication', (done) => {
                ...
                .end((err, res) => {
                    ...
                    chai
                        ...
                        .end((err, res) => {
                            ...
                            const token = res.body.dataObj.token;
