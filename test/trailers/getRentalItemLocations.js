...
describe('Trailer Rentals - Location Tracking', () => {
    ...
    describe('POST /rental/location ', () => {

        it('it should return 200 response with Rental Location Update', (done) => {
                                                    ...
                                                    .end((err, res) => {
                                                        ...
                                                        chai
                                                            ...
                                                            .end((err, res) => {
                                                                ...
                                                                const rentalId = rentalObj._id.toString();
                                                                ...
                                                                chai
                                                                    ...
                                                                    .end((err, res) => {
                                                                        ...
                                                                        // console.log("POST /rental/status Response", res.body);
                                                                        ...
                                                                        const rentalLocationTrackingStartObj = {
                                                                            rentalId: rentalId,
                                                                            type: "dropoff",
                                                                            action: "start"
                                                                        };
                                                                        ...
                                                                        chai
                                                                            ...
                                                                            .set('Cookie', licenseeCookie)
                                                                            .field('reqBody', JSON.stringify(rentalLocationTrackingStartObj))
                                                                            .end((err, res) => {
                                                                                if (err) {
                                                                                    console.log("Error", err);
                                                                                }
                                                                                console.log("POST /rental/location/track Response", res.body);
                                                                                ...
                                                                                const rentalLocationUpdateObj = {
                                                                                    rentalId: rentalId,
                                                                                    location: [-33.5002, 150.8402],
                                                                                    type: "dropoff"
                                                                                };
                                                                                ...
                                                                                chai
                                                                                    ...
                                                                                    .set('Cookie', licenseeCookie)
                                                                                    .send(rentalLocationUpdateObj)
                                                                                    .end((err, res) => {
                                                                                        if (err) {
                                                                                            console.log("Error", err);
                                                                                        }
                                                                                        console.log("POST /rental/location Response", res.body);
                                                                                        ...
                                                                                        chai
                                                                                            .request(app)
                                                                                            .get(`/rental/locations?rentalId=${rentalId}`)
                                                                                            .set('Cookie', licenseeCookie)
                                                                                            .end((err, res) => {
                                                                                                if (err) {
                                                                                                    console.log("Error", err);
                                                                                                }
                                                                                                console.log("GET /rental/locations Response", res.body);
