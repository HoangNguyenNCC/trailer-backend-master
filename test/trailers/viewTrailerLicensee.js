...
describe('Trailer Rentals', () => {
    ...
    describe('POST /trailer/licensee ', () => {

        it('it should return 200 response with licenseeObj', (done) => {
                                                                                            ...
                                                                                            .end((err, res) => {
                                                                                                ...
                                                                                                chai
                                                                                                    ...
                                                                                                    .end((err, res) => {
                                                                                                        ...
                                                                                                        const getRouteLicensee = `/trailer/licensee?id=${licenseeObj._id}`;

                                                                                                        chai
                                                                                                        .request(app)
                                                                                                        .get(getRouteLicensee)
                                                                                                        .set('Cookie', userCookie)
                                                                                                        .end((err, res) => {
                                                                                                            if (err) {
                                                                                                                console.log("Error", err);
